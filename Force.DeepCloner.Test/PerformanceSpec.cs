...
namespace Force.DeepCloner.Tests
{
	...
	public class PerformanceSpec
	{
		...
		[TestMethod]
		public void Test_Construct_Safe_Class_Variants_Safe_False()
		{
			// we cache cloners for type, so, this only variant with separate run
			BaseTest.SwitchTo(false);
        ...
        [TestMethod]
		public void Test_Construct_Safe_Class_Variants_Safe_True()
		{
			// we cache cloners for type, so, this only variant with separate run
			BaseTest.SwitchTo(true);
			var c1 = new C3 { V1 = 1, V2 = "xxx" };
		...
		public void Test_Deep_Tree()
		{
			...
			Assert.AreEqual(ReferenceEquals(clone, clone.Item2.Item1.Item1.Item2), true);
			//return;
